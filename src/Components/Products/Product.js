...
const Product = ({ product, setProduct, handleBuy }) => {
                ...
                <div className='relative productImage'>
                    ...
                    <div className='productInfo hidden animate__animated animate__fadeInUp'>
                        <div className='absolute bottom-0 right-0 bg-black w-full grid grid-cols-2 opacity-80'>
                            <span onClick={() => handleBuy(product)} className="text-white focus:ring-4 focus:outline-none hover:bg-secondary focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center cursor-pointer">Buy</span>
